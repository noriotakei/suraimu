...
require_once(D_BASE_DIR . "/func/SendMagic/MimeMail.php");
require_once(D_BASE_DIR . "/func/SendMagic/MailEmoji.php");

class DecoMimeMail extends MimeMail{
