<?php /* Smarty version 2.6.26, created on 2014-08-09 10:59:16
         compiled from /home/suraimu/templates/admin/image/list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', '/home/suraimu/templates/admin/image/list.tpl', 106, false),array('function', 'html_radios', '/home/suraimu/templates/admin/image/list.tpl', 116, false),array('function', 'make_link', '/home/suraimu/templates/admin/image/list.tpl', 213, false),array('function', 'html_image', '/home/suraimu/templates/admin/image/list.tpl', 218, false),array('modifier', 'default', '/home/suraimu/templates/admin/image/list.tpl', 116, false),array('modifier', 'zend_date_format', '/home/suraimu/templates/admin/image/list.tpl', 121, false),array('modifier', 'count', '/home/suraimu/templates/admin/image/list.tpl', 137, false),array('modifier', 'implode', '/home/suraimu/templates/admin/image/list.tpl', 143, false),array('modifier', 'cat', '/home/suraimu/templates/admin/image/list.tpl', 213, false),)), $this); ?>
...
<form action="./" method="post" enctype="multipart/form-data">
    <table border="0" cellspacing="0" cellpadding="0" class="TableSet01">
        <tr>
            <th>カテゴリー</th>
            <td style="text-align: left;"><?php echo smarty_function_html_options(array('name' => 'image_category_id','options' => $this->_tpl_vars['categoryList'],'selected' => $this->_tpl_vars['registParam']['image_category_id']), $this);?>
</td>
        </tr>
        <tr>
            <th>名前</th>
...
<br>
<?php if ($this->_tpl_vars['imageList']): ?>
...
件表示しています
    ...
    <?php $_from = $this->_tpl_vars['imageList']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['val']):
?>
        <tr>
        <td><a href="<?php echo smarty_function_make_link(array('action' => 'action_image_ImageUpd','getTags' => ((is_array($_tmp="image_id=")) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['val']['id']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['val']['id']))), $this);?>
"><?php echo $this->_tpl_vars['val']['id']; ?>
        ...
        <div class="images">
            <?php if ($this->_tpl_vars['val']['extension_type'] == IMAGETYPE_SWF || $this->_tpl_vars['val']['extension_type'] == IMAGETYPE_SWC): ?>
                <a href="./<?php echo $this->_tpl_vars['imagePath']; ?>
...
">
                <?php echo smarty_function_html_image(array('file' => "./img/thumbnails/swf.jpg",'width' => '80','height' => '60','alt' => $this->_tpl_vars['val']['name']), $this);?>
</a>
            <?php else: ?>
                <a href="./<?php echo $this->_tpl_vars['imagePath']; ?>
<?php echo $this->_tpl_vars['val']['file_name']; ?>
...
" toptions="type = image, group = 'images', parameters = '<?php echo time(); ?>
 =1', title=<?php echo $this->_tpl_vars['val']['name']; ?>
">
                <?php echo smarty_function_html_image(array('file' => ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp="./")) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['imagePath']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['imagePath'])))) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['val']['file_name']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['val']['file_name'])))) ? $this->_run_mod_handler('cat', true, $_tmp, ".") : smarty_modifier_cat($_tmp, ".")))) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['extensionTypeArray'][$this->_tpl_vars['val']['extension_type']]) : smarty_modifier_cat($_tmp, $this->_tpl_vars['extensionTypeArray'][$this->_tpl_vars['val']['extension_type']])))) ? $this->_run_mod_handler('cat', true, $_tmp, "?") : smarty_modifier_cat($_tmp, "?")))) ? $this->_run_mod_handler('cat', true, $_tmp, time()) : smarty_modifier_cat($_tmp, time())),'width' => '100','height' => '70','alt' => $this->_tpl_vars['val']['name']), $this);?>
</a>
            <?php endif; ?>
        </div>
        </td>
        ...
        <td><?php echo $this->_tpl_vars['categoryList'][$this->_tpl_vars['val']['image_category_id']]; ?>
</td>
        <td>
            <?php if ($this->_tpl_vars['val']['extension_type'] == IMAGETYPE_SWF || $this->_tpl_vars['val']['extension_type'] == IMAGETYPE_SWC): ?>
                <textarea class="selectText" readonly cols="50"><?php echo $this->_tpl_vars['imagePath']; ?>
<?php echo $this->_tpl_vars['val']['file_name']; ?>
.<?php echo $this->_tpl_vars['extensionTypeArray'][$this->_tpl_vars['val']['extension_type']]; ?>
</textarea>
            <?php else: ?>
                <textarea class="selectText" readonly cols="50"><img src="<?php echo $this->_tpl_vars['imagePath']; ?>
<?php echo $this->_tpl_vars['val']['file_name']; ?>
.<?php echo $this->_tpl_vars['extensionTypeArray'][$this->_tpl_vars['val']['extension_type']]; ?>
"></textarea>
            <?php endif; ?>
