<?php /* Smarty version 2.6.26, created on 2014-10-22 12:43:43
         compiled from /home/suraimu/templates/admin/mailLog/reservePointGrantList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', '/home/suraimu/templates/admin/mailLog/reservePointGrantList.tpl', 51, false),array('modifier', 'zend_date_format', '/home/suraimu/templates/admin/mailLog/reservePointGrantList.tpl', 51, false),array('modifier', 'count', '/home/suraimu/templates/admin/mailLog/reservePointGrantList.tpl', 63, false),array('modifier', 'implode', '/home/suraimu/templates/admin/mailLog/reservePointGrantList.tpl', 69, false),array('modifier', 'cat', '/home/suraimu/templates/admin/mailLog/reservePointGrantList.tpl', 103, false),array('modifier', 'emoji', '/home/suraimu/templates/admin/mailLog/reservePointGrantList.tpl', 104, false),array('function', 'make_link', '/home/suraimu/templates/admin/mailLog/reservePointGrantList.tpl', 103, false),)), $this); ?>
...
?>
        <tr>
        <td><a href="<?php echo smarty_function_make_link(array('action' => 'action_mailLog_ReservePointGrantData','getTags' => ((is_array($_tmp="reserve_point_grant_id=")) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['val']['id']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['val']['id']))), $this);?>
" target="_blank"><?php echo $this->_tpl_vars['val']['id']; ?>
</a></td>
        <td><?php echo ((is_array($_tmp=$this->_tpl_vars['val']['update_user_point_datetime'])) ? $this->_run_mod_handler('emoji', true, $_tmp) : smarty_modifier_emoji($_tmp)); ?>
</td>
        <td><?php echo ((is_array($_tmp=$this->_tpl_vars['val']['target_user_count'])) ? $this->_run_mod_handler('emoji', true, $_tmp) : smarty_modifier_emoji($_tmp)); ?>
</td>
        <td><?php echo ((is_array($_tmp=$this->_tpl_vars['val']['point'])) ? $this->_run_mod_handler('emoji', true, $_tmp) : smarty_modifier_emoji($_tmp)); ?>
pt</td>
        <td><?php echo ((is_array($_tmp=$this->_tpl_vars['val']['description'])) ? $this->_run_mod_handler('emoji', true, $_tmp) : smarty_modifier_emoji($_tmp)); ?>
</td>
        <?php if ($this->_tpl_vars['val']['is_exec'] == 0): ?>
        ...
        <td>
            <form action="./" method="post" style="margin:2px 0px;">
                ...
                <input type="hidden" name="reserve_point_grant_id" value="<?php echo $this->_tpl_vars['val']['id']; ?>
">
