<?php /* Smarty version 2.6.26, created on 2014-12-18 15:38:55
         compiled from /home/suraimu/templates/admin/unit/unitCreate.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', '/home/suraimu/templates/admin/unit/unitCreate.tpl', 7, false),array('modifier', 'implode', '/home/suraimu/templates/admin/unit/unitCreate.tpl', 13, false),)), $this); ?>
...
<body>
<div id="ContentsCol">
    <h2 class="ContentTitle">ユニットデータ作成</h2>
...
件</td>
            ...
            <tr>
                <th>ユニット名</th>
                <td><input type="text" name="comment" size="30" value=""></td>
            </tr>
            <tr>
                <td colspan="2" style="text-align:center;"><input type="submit" value="ユニット作成" name="action_unit_UnitCreateExec"  onClick="return confirm('ユニット作成しますか？')"/></td>
            </tr>
        </table>
    </form>
<?php else: ?>
