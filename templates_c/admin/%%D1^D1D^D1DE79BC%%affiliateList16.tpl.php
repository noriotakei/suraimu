<?php /* Smarty version 2.6.26, created on 2014-11-25 11:49:43
         compiled from /home/suraimu/templates/admin/affiliate16/affiliateList16.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', '/home/suraimu/templates/admin/affiliate16/affiliateList16.tpl', 64, false),array('modifier', 'implode', '/home/suraimu/templates/admin/affiliate16/affiliateList16.tpl', 70, false),array('modifier', 'default', '/home/suraimu/templates/admin/affiliate16/affiliateList16.tpl', 94, false),array('modifier', 'cat', '/home/suraimu/templates/admin/affiliate16/affiliateList16.tpl', 163, false),array('function', 'html_radios', '/home/suraimu/templates/admin/affiliate16/affiliateList16.tpl', 94, false),array('function', 'html_checkboxes', '/home/suraimu/templates/admin/affiliate16/affiliateList16.tpl', 98, false),array('function', 'make_link', '/home/suraimu/templates/admin/affiliate16/affiliateList16.tpl', 163, false),)), $this); ?>
...
" style="ime-mode:disabled" size="20">
        ...
        <tr>
            <td colspan="2" style="text-align:center;">
                <input type="submit" value="登　録" name="action_affiliate16_AffiliateRegExec16" onClick="return confirm('登録しますか？')">
            </td>
        </tr>
    </table>
</form>
...
?>
        <tr>
        <td><a href="<?php echo smarty_function_make_link(array('action' => 'action_affiliate16_AffiliateUpd16','getTags' => ((is_array($_tmp="id=")) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['val']['id']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['val']['id']))), $this);?>
...
">
                ...
                <input type="submit" name="action_affiliate16_AffiliateRegExec16" value="削除" onClick="return confirm('削除しますか?')">
            </form>
        </td>
        </tr>
    <?php endforeach; endif; unset($_from); ?>
