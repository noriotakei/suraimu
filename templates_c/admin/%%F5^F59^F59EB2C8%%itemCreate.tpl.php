<?php /* Smarty version 2.6.26, created on 2014-08-13 16:22:13
         compiled from /home/suraimu/templates/admin/itemManagement/itemCreate.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', '/home/suraimu/templates/admin/itemManagement/itemCreate.tpl', 66, false),array('modifier', 'implode', '/home/suraimu/templates/admin/itemManagement/itemCreate.tpl', 72, false),array('modifier', 'default', '/home/suraimu/templates/admin/itemManagement/itemCreate.tpl', 123, false),array('modifier', 'zend_date_format', '/home/suraimu/templates/admin/itemManagement/itemCreate.tpl', 129, false),array('function', 'html_options', '/home/suraimu/templates/admin/itemManagement/itemCreate.tpl', 118, false),array('function', 'make_link', '/home/suraimu/templates/admin/itemManagement/itemCreate.tpl', 189, false),array('function', 'html_radios', '/home/suraimu/templates/admin/itemManagement/itemCreate.tpl', 192, false),)), $this); ?>
...
<div id="ContentsCol">
    <h2 class="ContentTitle">商品登録画面</h2>
...
" size="100">
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    <input type="text" name="html_text_name_pc" value="<?php echo $this->_tpl_vars['returnParam']['html_text_name_pc']; ?>
" size="100">
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    <input type="text" name="html_text_name_mb" value="<?php echo $this->_tpl_vars['returnParam']['html_text_name_mb']; ?>
" size="100">
                    &nbsp;<font color="blue">※HTMLタグを入力出来ます。</font>
                </td>
                <td style="text-align:center;color:#ff0000;">必須</td>
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    <input type="text" name="remail_name" value="<?php echo $this->_tpl_vars['returnParam']['remail_name']; ?>
" size="100">
                </td>
                <td style="text-align:center;color:#ff0000;">必須</td>
            </tr>
            <tr>
                <th>カテゴリー</th>
                <td style="text-align: left;"><?php echo smarty_function_html_options(array('name' => 'item_category_id','options' => $this->_tpl_vars['itemCategoryListForSelect'],'selected' => $this->_tpl_vars['registParam']['item_category_id']), $this);?>
</td>
            ...
            <tr>
                <th>販売開始日時</th>
                <td style="text-align: left;">
                    <input name="sales_start_date" class="datepicker" type="text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['returnParam']['sales_start_datetime'])) ? $this->_run_mod_handler('zend_date_format', true, $_tmp, 'yyyy-MM-dd') : smarty_modifier_zend_date_format($_tmp, 'yyyy-MM-dd')); ?>
" size="15" maxlength="10">
                    <input name="sales_start_time" class="time" type="text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['returnParam']['sales_start_datetime'])) ? $this->_run_mod_handler('zend_date_format', true, $_tmp, 'HH:mm:ss') : smarty_modifier_zend_date_format($_tmp, 'HH:mm:ss')); ?>
" size="10" maxlength="8">
            ...
            <tr>
                <th>販売終了日時</th>
                <td style="text-align: left;">
                    <input name="sales_end_date" class="datepicker" type="text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['returnParam']['sales_end_datetime'])) ? $this->_run_mod_handler('zend_date_format', true, $_tmp, 'yyyy-MM-dd') : smarty_modifier_zend_date_format($_tmp, 'yyyy-MM-dd')); ?>
" size="15" maxlength="10">
                    <input name="sales_end_time" class="time" type="text" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['returnParam']['sales_end_datetime'])) ? $this->_run_mod_handler('zend_date_format', true, $_tmp, 'HH:mm:ss') : smarty_modifier_zend_date_format($_tmp, 'HH:mm:ss')); ?>
" size="10" maxlength="8">
                    &nbsp;<font color="blue">※日付は「0000-00-00 00:00:00」の形で入力してください。</font>
                </td>
...
" size="10" maxlength="8">まで
            ...
            <tr>
                <th>入金状態</th>
                <td style="text-align: left;"><?php echo smarty_function_html_options(array('name' => 'payment_status','options' => $this->_tpl_vars['paymentStatus'],'selected' => ((is_array($_tmp=@$this->_tpl_vars['registParam']['payment_status'])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0))), $this);?>
</td>
                <td style="text-align: center;">-----</td>
            </tr>
            <tr>
...
" target="_blank">検索条件保存リスト</a></th>
                <td style="text-align: left;">
                    <input type="text" name="user_search_conditions_id" value="" size="80" style="ime-mode:disabled">
...
" target="_blank">検索条件保存リスト</a></th>
                <td style="text-align: left;">
                    <input type="text" name="except_user_search_conditions_id" value="" size="80" style="ime-mode:disabled">
...
<br>
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    ﾘﾀﾞｲﾚｸﾄ商品ID<input type="text" size="80" name="redirect_unit_item_id" value="" style="ime-mode:disabled">
                    </br>
                    ﾘﾀﾞｲﾚｸﾄﾕﾆｯﾄID<input type="text" size="80" name="redirect_unit_id" value="" style="ime-mode:disabled">
                    </br>
            ...
            <tr>
                ...
                <td style="text-align:left;">
                    <input type="text" size="80" name="target_delete_item_id" value="<?php echo $this->_tpl_vars['returnParam']['target_delete_item_id']; ?>
" style="ime-mode:disabled">
                    </br>
            ...
            <tr>
                <th>販売価格</th>
                <td style="text-align: left;">
                    <input type="text" name="price" value="<?php echo $this->_tpl_vars['returnParam']['price']; ?>
" size="10" style="ime-mode:disabled">&nbsp;円
                </td>
                <td style="text-align: center;"><font color="red">必須</font></td>
            </tr>
            <tr>
                <th>付与ポイント</th>
                <td style="text-align: left;">
...
" size="10" style="ime-mode:disabled">&nbsp;Pt
            ...
            <tr>
                <th>付与月額コース</th>
                <td style="text-align: left;">
                    <?php echo smarty_function_html_options(array('name' => 'monthly_course_id','options' => $this->_tpl_vars['monthlyCourseList'],'selected' => ((is_array($_tmp=@$this->_tpl_vars['registParam']['monthlyCourseList'])) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0)),'id' => 'monthly_course_id'), $this);?>

                    <div id="monthly_course_plus_limit_date" style="display:none;">
                        付与月額コース日数:<input type="text" name="monthly_course_plus_limit_date" value="" size="10">日
                    </div>
                    <div id="monthly_update_item_id" style="display:none;">
                        月額更新用商品ID:<input type="text" name="monthly_update_item_id" value="" size="10">
            ...
            <tr>
                <th>管理用コメント</th>
                <td style="text-align: left;">
                    <textarea name="comment" cols="80" rows="2" id="comment"><?php echo $this->_tpl_vars['returnParam']['comment']; ?>
</textarea>
                </td>
                <td style="text-align: center;">任意</td>
            </tr>
...
" size="10" style="ime-mode:disabled">
            ...
            <tr>
                <td colspan="3"  style="text-align:center;">
                    <div class="SubMenu">
                        <input type="submit" name="action_itemManagement_itemExec" value="登録する" onClick="return confirm('登録しますか？')"/>
                    </div>
                </td>
            </tr>
        </table>
