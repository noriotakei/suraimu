<?php /* Smarty version 2.6.26, created on 2014-10-19 15:06:13
         compiled from /home/suraimu/templates/admin/lotteryUnitPrize/unitCreate.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', '/home/suraimu/templates/admin/lotteryUnitPrize/unitCreate.tpl', 7, false),array('modifier', 'implode', '/home/suraimu/templates/admin/lotteryUnitPrize/unitCreate.tpl', 13, false),)), $this); ?>
...
?>
        <table border="0" cellspacing="0" cellpadding="0" class="TableSet04">
            <tr>
                <th>当選確率</th>
                <td><input type="text" name="number[]" size="5" value="<?php echo $this->_tpl_vars['returnValue']['number'][$this->_sections['cnt']['index']]; ?>
" style="ime-mode:disabled">％</td>
                <th>賞品名</th>
                <td><input type="text" name="comment[]" size="30" value="<?php echo $this->_tpl_vars['returnValue']['comment'][$this->_sections['cnt']['index']]; ?>
"></td>
            </tr>
        </table>
        <?php endfor; endif; ?>
        ...
        <table border="0" cellspacing="0" cellpadding="0" class="TableSet04">
            <tr>
                <td colspan="2" style="text-align:center;"><input type="submit" value="抽選ユニット作成" name="action_lotteryUnitPrize_UnitCreateExec"  onClick="return confirm('抽選ユニット作成しますか？')"/></td>
            </tr>
        </table>
    </form>
<?php else: ?>
