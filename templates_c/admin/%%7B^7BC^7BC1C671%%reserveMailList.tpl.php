<?php /* Smarty version 2.6.26, created on 2014-11-20 14:22:13
         compiled from /home/suraimu/templates/admin/mailLog/reserveMailList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', '/home/suraimu/templates/admin/mailLog/reserveMailList.tpl', 53, false),array('modifier', 'zend_date_format', '/home/suraimu/templates/admin/mailLog/reserveMailList.tpl', 53, false),array('modifier', 'count', '/home/suraimu/templates/admin/mailLog/reserveMailList.tpl', 83, false),array('modifier', 'implode', '/home/suraimu/templates/admin/mailLog/reserveMailList.tpl', 89, false),array('modifier', 'cat', '/home/suraimu/templates/admin/mailLog/reserveMailList.tpl', 124, false),array('modifier', 'emoji', '/home/suraimu/templates/admin/mailLog/reserveMailList.tpl', 127, false),array('function', 'make_link', '/home/suraimu/templates/admin/mailLog/reserveMailList.tpl', 124, false),)), $this); ?>
...
" size="10"maxlength="8"></td>
        ...
        <tr>
            <td>予約メルマガＩＤ</td>
            <td>
                <input type="text" name="mailmagazine_id" value="<?php echo $this->_tpl_vars['param']['mailmagazine_id']; ?>
" size="70" style="ime-mode:disabled;">
            </td>
        </tr>
        <tr>
            <td>メルマガ件名検索 </td>
...
?>
        <tr>
        <td><a href="<?php echo smarty_function_make_link(array('action' => 'action_mailLog_ReserveMailData','getTags' => ((is_array($_tmp="mail_maga_reserve_id=")) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['val']['id']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['val']['id']))), $this);?>
" target="_blank"><?php echo $this->_tpl_vars['val']['id']; ?>
</a></td>
        <td><?php echo $this->_tpl_vars['val']['send_datetime']; ?>
</td>
        <td><?php echo $this->_tpl_vars['val']['send_plans_count']; ?>
</td>
        ...
        <td><?php if ($this->_tpl_vars['val']['is_send']): ?>配信済み<?php else: ?><font color="red">未配信</font><?php endif; ?></td>
        ...
        <td>
            <form action="./" method="post" style="margin:2px 0px;">
                ...
                <input type="hidden" name="mail_maga_reserve_id" value="<?php echo $this->_tpl_vars['val']['id']; ?>
">
