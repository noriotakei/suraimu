<?php /* Smarty version 2.6.26, created on 2014-11-22 10:42:31
         compiled from /home/suraimu/templates/admin/user/searchConditionCategoryList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', '/home/suraimu/templates/admin/user/searchConditionCategoryList.tpl', 37, false),array('modifier', 'implode', '/home/suraimu/templates/admin/user/searchConditionCategoryList.tpl', 43, false),)), $this); ?>
...
<h2 class="ContentTitle">検索条件カテゴリー一覧</h2>
...
" size="40"></td>
        <td><input type="submit" name="action_user_SearchConditionCategoryExec" value="登　録" onClick="return confirm('登録しますか？')" /></td>
    </tr>
    </table>
</form>
<br>
...
" size="40"></td>
    ...
    <div class="SubMenu">
        <input type="submit" name="action_user_SearchConditionCategoryExec" value="更　新" onClick="return confirm('更新しますか？')" />
    </div>
</form>
<?php else: ?>
    <div class="warning ui-widget">
