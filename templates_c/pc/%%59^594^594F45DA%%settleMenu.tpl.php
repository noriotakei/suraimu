<?php /* Smarty version 2.6.26, created on 2014-08-08 15:50:38
         compiled from /home/suraimu/templates/www/include/settleMenu.tpl */ ?>
<div id="pay">
<div id="titleSettle">お支払い方法の選択</div>
<div id="bank"><a href="./?action_SettleBank=1&<?php echo $this->_tpl_vars['URLparam']; ?>
<?php if ($this->_tpl_vars['comURLparam']): ?>&<?php echo $this->_tpl_vars['comURLparam']; ?>
<?php endif; ?>">銀行振込</a></div>
...
メールアドレス：
<a href="mailto:info@<?php echo $this->_tpl_vars['config']['define']['MAIL_DOMAIN']; ?>
">
<span style="color:white;text-align:left;">
info@<?php echo $this->_tpl_vars['config']['define']['MAIL_DOMAIN']; ?>
...
<!-- NET銀行 
<div id="banknet"><a href="./?action_SettleNetBank=1&<?php echo $this->_tpl_vars['URLparam']; ?>
<?php if ($this->_tpl_vars['comURLparam']): ?>&<?php echo $this->_tpl_vars['comURLparam']; ?>
<?php endif; ?>">ネット銀行(24時間OK)</a><img src="img/settle_24h.gif" alt="24時間対応" /></div>
...
<hr />
-->
<div id="credit"><a href="./?action_SettleTelecom=1&<?php echo $this->_tpl_vars['URLparam']; ?>
<?php if ($this->_tpl_vars['comURLparam']): ?>&<?php echo $this->_tpl_vars['comURLparam']; ?>
<?php endif; ?>">クレジットカード</a><img src="img/settle_24h.gif" alt="24時間対応" /></div>
...
<div id="cvd"><a href="./?action_SettleCvd=1&<?php echo $this->_tpl_vars['URLparam']; ?>
<?php if ($this->_tpl_vars['comURLparam']): ?>&<?php echo $this->_tpl_vars['comURLparam']; ?>
<?php endif; ?>">コンビニ決済</a><img src="img/settle_24h.gif" alt="24時間対応" /></div>
...
<div id="bitcash"><a href="./?action_SettleBitcash=1&<?php echo $this->_tpl_vars['URLparam']; ?>
<?php if ($this->_tpl_vars['comURLparam']): ?>&<?php echo $this->_tpl_vars['comURLparam']; ?>
<?php endif; ?>">BITCASH決済</a><img src="img/settle_24h.gif" alt="24時間対応" /></div>
...
<p class="attention"><a href="./?action_ItemList=1<?php if ($this->_tpl_vars['comURLparam']): ?>&<?php echo $this->_tpl_vars['comURLparam']; ?>
<?php endif; ?>">他のキャンペーンを見てみる</a></p>