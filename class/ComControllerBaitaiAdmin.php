...
class ComControllerBaitaiAdmin extends ComController {

    /** ビジネスロジック格納ディレクトリ */
    const BUSINESSLOGIC_PATH = "/action/baitaiAdmin/";

    /** HTML表示ファイル格納ディレクトリ */
    const TEMPLATE_PATH = "/templates/baitaiAdmin/";

    /** インクルードファイル格納ディレクトリ */
    const INCLUDE_PATH = "/action/baitaiAdmin/include/";

    /** インクルードHTML表示ファイル格納ディレクトリ */
    const INCLUDE_TEMPLATE_PATH = "/templates/baitaiAdmin/include/";
