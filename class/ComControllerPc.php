...
class ComControllerPc extends ComController {

    /** ビジネスロジック格納ディレクトリ */
    const BUSINESSLOGIC_PATH = "/action/www/";

    /** HTML表示ファイル格納ディレクトリ */
    const TEMPLATE_PATH = "/templates/www/";

    /** インクルードファイル格納ディレクトリ */
    const INCLUDE_PATH = "/action/www/include/";

    /** インクルードHTML表示ファイル格納ディレクトリ */
    const INCLUDE_TEMPLATE_PATH = "/templates/www/include/";
