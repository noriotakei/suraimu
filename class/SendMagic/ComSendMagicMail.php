 ...
 *
 */
class SendMagic_ComSendMagicMail extends SendMagic_ComDecoMimeMail{
    protected $sendStart = "";
    ...
    protected function smtpSend(){
        ...
        //if ($this->_openSmtpConn()){
            ...
            */
            ...
            // SendMagic拡張ヘッダ
            //-20131122-takuro sendMagic→カエデ切り替えの為、sendmagic特有処理を外します
            //$this->_sendSmtpCommand($this->_getSmExtensionHeader() . $this->mail_header);
