...
class SendMagic_ComEmoji {
    ...
    protected static function docomoEncode($str) {
        $emoji =& SendMagic_ComEmojiConfig::getDocomoEmoji();
    ...
    protected static function ezwebEncode($str) {
        $emoji =& SendMagic_ComEmojiConfig::getEzwebEmoji();
    ...
    protected static function softbankEncode($str) {
        $emoji =& SendMagic_ComEmojiConfig::getSoftbankEmoji();
    ...
    private static function jphoneEncodeCallback($matches) {
        $emoji =& SendMagic_ComEmojiConfig::getJphoneEmoji();
