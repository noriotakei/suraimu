...
<body>
<div id="ContentsCol">
<h2 class="ContentTitle">媒体CHK管理者一覧</h2>
{* 更新時エラーコメント *}
{if $execMsg|@count}
...
{if $baitaiList}
    ...
    {foreach from=$baitaiList item="val"}
        <tr>
        <td><a href="{make_link action="action_baitai_BaitaiUserUpd" getTags="id="|cat:$val.id}">{$val.login_id}</a></td>
        <td>{$val.name}</td>
        </tr>
    {/foreach}
    </table>
    ...
    <table class="TableSet04">
        ...
        <tr>
            <td colspan="2" style="text-align:center;">
                <input type="submit" value="登　録" name="action_baitai_BaitaiUserRegExec" onClick="return confirm('登録しますか？')">
            </td>
        </tr>
    </table>
</form>
