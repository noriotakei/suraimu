...
<div id="ContentsCol">
    <h2 class="ContentTitle">月額コースグループ更新画面</h2>
    {* 更新時エラーコメント *}
    {if $msg|@count}
    ...
    <form action="./" method="post">
        <div class="SubMenu">
            <input type="submit" name="action_MonthlyCourse_GroupList" value="一覧に戻る" />
        </div>
    </form>
        ...
        <table border="0" cellspacing="0" cellpadding="0" class="TableSet01">
            ...
            <tr>
                <td colspan="3"  style="text-align:center;">
                    <div class="SubMenu">
                        <input type="submit" name="action_MonthlyCourse_GroupExec" value="更新する" onClick="return confirm('更新しますか？')"/>
                    </div>
                </td>
            </tr>
        </table>
