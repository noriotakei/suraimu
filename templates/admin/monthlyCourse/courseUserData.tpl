...
<form action="./" method="post">
    {$POSTparam}
    <div class="SubMenu">
        <input type="submit" name="action_monthlyCourse_CourseUserSearchList" value="一覧に戻る" />
    </div>
</form>
<br>
<div class="SubMenu">
    ...
    <table border="0" cellspacing="0" cellpadding="0" class="TableSet01">
        ...
        <tr>
            <td colspan="3"  style="text-align:center;">
                <div class="SubMenu">
                    <input type="submit" name="action_monthlyCourse_CourseUserExec" value="付与する" onClick="return confirm('付与しますか？')"/>
                </div>
            </td>
        </tr>
    </table>
