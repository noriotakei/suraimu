...
<form action="./" method="post">
    <input type="submit" name="action_affiliate16_AffiliateList16" value="一覧へ戻る" style="width:8em;"/>
</form>
<br>
<form action="./" method="POST">
    {$POSTparam}
    <table class="TableSet04">
        ...
        <tr>
            <td colspan="2" style="text-align:center;">
                <input type="submit" value="更　新" name="action_affiliate16_AffiliateRegExec16" onClick="return confirm('更新しますか？')">
            </td>
        </tr>
    </table>
</form>
