...
{if $totalCount}
    <form action="./" method="post">
        ...
        <table border="0" cellspacing="0" cellpadding="0" class="TableSet04">
            <tr>
                <th>当選確率</th>
                <td><input type="text" name="number[]" size="5" value="{$returnValue.number[$smarty.section.cnt.index]}" style="ime-mode:disabled">％</td>
                <th>賞品名</th>
                <td><input type="text" name="comment[]" size="30" value="{$returnValue.comment[$smarty.section.cnt.index]}"></td>
            </tr>
        </table>
        {/section}
        <br>
