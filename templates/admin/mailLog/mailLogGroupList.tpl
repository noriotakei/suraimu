...
<h2 class="ContentTitle">定期メルマガID毎配信履歴一覧</h2>
    ...
    <table border="0" cellspacing="0" cellpadding="0" class="TableSet04" id="src_table">
        ...
        <tr>
            <td style="text-align:center;" colspan="2">
                <input type="submit" name="action_mailLog_MailLogGroupList" value="検 索" style="width:8em;"/>
            </td>
        </tr>
    </table>
</form>
...
{if $logDataList}
    ...
    <tr>
    <th><a href="{make_link action="action_mailLog_MailLogGroupList" getTags=$sortURLparam|cat:"&sort=regular"}">定期メルマガID</a></th>
    <th>PC件名</th>
    <th>MB件名</th>
    <th>PC成功</th>
    <th>PC失敗</th>
    ...
    <th><a href="{make_link action="action_mailLog_MailLogGroupList" getTags=$sortURLparam|cat:"&sort=pc_access"}">PCのべ<br>アクセス数</a></th>
    <th><a href="{make_link action="action_mailLog_MailLogGroupList" getTags=$sortURLparam|cat:"&sort=pc_access_percent"}">PCアクセス率</a></th>
    <th><a href="{make_link action="action_mailLog_MailLogGroupList" getTags=$sortURLparam|cat:"&sort=mb_access"}">MBのべ<br>アクセス数</a></th>
    <th><a href="{make_link action="action_mailLog_MailLogGroupList" getTags=$sortURLparam|cat:"&sort=mb_access_percent"}">MBアクセス率</a></th>
    </tr>
