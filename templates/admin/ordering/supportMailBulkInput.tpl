...
<!--
    ...
    $(function() {ldelim}
        ...
        $('.reserve').live("click", function(env){ldelim}
    ...
    {rdelim});
        ...
        // 送信確認文言
        $('#submit').live("click", function(env){ldelim}
            if (env.button !== 0) return;
        ...
        <form action="./" method="post" enctype="multipart/form-data">
            ...
            <table border="0" cellspacing="0" cellpadding="0" id="list_table" class="TableSet04">
                ...
                <td style="text-align: left;" colspan="2">
                    {html_radios class="reserve" name="mail_reserve_type" options=$mailReserveType selected=$mailElements.mail_reserve_type|default:0 separator="&nbsp;"}
                    <div id="reserve_datetime">
                        <input size="15" class="datepicker" type="text" value="{$mailElements.reserve_datetime_Date|default:$smarty.now|zend_date_format:'yyyy-MM-dd'}" name="reserve_datetime_Date" maxlength="10">
                        <input name="reserve_datetime_Time" class="time" type="text" value="{$mailElements.reserve_datetime_Time|date_format:'%H:%M'}" size="7" maxlength="5">
                    </div>
                    <div id="interval" style="display:none;">
                        インターバル(30分を設定してください):<br>{html_options name="interval_second" options=$intervalSecond selected=$mailElements.interval_second|default:2}分
                    </div>
                    <div id="regular">
                        <div id="title">
                            タイトル:<input type="text" name="title" value="{$mailElements.title}" size="50">
                        </div>
                        {html_options class="regular" name="send_condition_type" options=$sendConditionType selected=$mailElements.send_condition_type|default:1}
                        <div id="regular_hour">
                            ...
                            {html_options name="regular_second" options=$intervalSecond selected=$mailElements.interval_second}分に送信する
                        </div>
                        <div id="regular_week">
                            {html_options name="regular_week" options=$config.admin_config.week_array selected=$mailElements.regular_week}
                            <input name="send_time_week" class="time" type="text" value="{$mailElements.send_time_week}" size="7" maxlength="5">に送信する
                        </div>
                        <div id="regular_month">
                            {html_options name="send_day" options=$dayAry selected=$mailElements.send_day}日
                            <input name="send_time_month" class="time" type="text" value="{$mailElements.send_time_month}" size="7" maxlength="5">に送信する
                        </div>
                        <div id="regular_day">
                            <input name="send_time_day" class="time" type="text" value="{$mailElements.send_time_day}" size="7" maxlength="5">に送信する
                        </div>
                    </div>
                </td>
                </tr>
                ...
                <tr>
                    ...
                    <td  style="text-align: left;">
                        <div id="pc_tabs">
                            ...
                            <div id="pc-tabs-1">
                                <textarea name="pc_html_body" cols="100" rows="30" id="pc_html_contents" wrap="off">{$param.pc_html_body}</textarea>
                            </div>
                ...
                <tr>
                    ...
                    <td  style="text-align: left;">
                        <div id="mb_tabs">
                            ...
                            <div id="mb-tabs-1">
                                <textarea name="mb_html_body" cols="100" rows="30" id="mb_html_contents" wrap="off">{$param.mb_html_body}</textarea>
                            </div>
