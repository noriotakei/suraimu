...
<h2 class="ContentTitle">システム変換表カテゴリー一覧</h2>
{* 更新時エラーコメント *}
{if $msg|@count}
...
<form action="./" method="post" enctype="multipart/form-data">
    ...
    <tr>
        ...
        <td><input type="submit" name="action_keyConvert_KeyConvertCategoryExec" value="登　録" onClick="return confirm('登録しますか？')" /></td>
    </tr>
    </table>
</form>
<br>
...
<form action="./" method="post">
    ...
    <div class="SubMenu">
        <input type="submit" name="action_keyConvert_KeyConvertCategoryExec" value="更　新" onClick="return confirm('更新しますか？')" />
    </div>
</form>
{else}
    <div class="warning ui-widget">
