...
<table cellspacing="0" cellpadding="0" class="TableSet01" id="table" align="center">
    ...
    <tr>
        <td><a href="{make_link action="action_mailLog_MailLogData" getTags="mail_maga_id="|cat:$val.mailmagazine_log_id_regular}" target="_blank">{$val.mailmagazine_log_id_regular}</a></td>
