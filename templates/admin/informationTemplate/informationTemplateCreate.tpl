...
<div id="ContentsCol">
    <h2 class="ContentTitle">情報定型文登録画面</h2>
    {* 更新時エラーコメント *}
    {if $msg|@count}
    ...
    {$POSTparam}
        <table border="0" cellspacing="0" cellpadding="0" class="TableSet01">
            ...
            <tr>
                ...
                <td style="text-align: left;">
                <textarea name="html_text_banner_pc" cols="100" rows="20" id="html_text_banner_pc" wrap="off">{$registParam.html_text_banner_pc}</textarea>
                </td>
                <td style="text-align: center;">任意</td>
            </tr>
            <tr>
                ...
                <td style="text-align: left;"><br>
                    <b><font color="blue">ユーザー側全画面表示設定(PCのみ)：</font></b>{html_options name="is_all_display" options=$isAllDisplay selected=$registParam.is_all_display|default:0 id="all_disp_type}<br><br>
                    ...
                    <textarea name="html_text_pc" class="inputBody" cols="100" rows="20" id="html_text_pc" wrap="off">{$registParam.html_text_pc}</textarea>
                    </td>
                <td style="text-align: center;">任意</td>
            </tr>
            <tr>
                ...
                <td style="text-align: left;">
                <textarea name="html_text_banner_mb" cols="100" rows="20" id="html_text_banner_mb" wrap="off">{$registParam.html_text_banner_mb}</textarea>
                </td>
                <td style="text-align: center;">任意</td>
            </tr>
            <tr>
                ...
                <textarea name="html_text_mb" class="inputBody" cols="100" rows="20" id="html_text_mb" wrap="off">{$registParam.html_text_mb}</textarea>
                </td>
                <td style="text-align: center;">任意</td>
            </tr>
            <tr>
                <td colspan="3"  style="text-align:center;">
                    <div class="SubMenu">
                        <input type="submit" name="action_informationTemplate_InformationTemplateExec" value="登録する" onClick="return confirm('登録しますか？')"/>
                    </div>
                </td>
            </tr>
        </table>
