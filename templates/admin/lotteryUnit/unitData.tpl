...
<body>
<div id="ContentsCol">
    <h2 class="ContentTitle">抽選ユニットデータ更新画面</h2>
    {* 更新時エラーコメント *}
    {if $msg|@count}
    ...
    <form action="./" method="post">
        <div class="SubMenu">
            <input type="submit" name="action_lotteryUnit_List" value="一覧に戻る" />
        </div>
    </form>
    {if $param}
        ...
        <form action="./" method="post">
            ...
            <div class="SubMenu">
                <input type="submit" name="action_lotteryUnit_UnitUpdExec" value="更　新" onClick="return confirm('更新しますか？')" />
            </div>
        </form>
    {else}
        <div class="warning ui-widget">
