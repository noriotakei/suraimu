    ...
    {$POSTparam}
        <table border="0" cellspacing="0" cellpadding="0" class="TableSet01">
            ...
            <tr>
                <th>販売価格</th>
                <td style="text-align: left;">
                    <input type="text" name="price" value="{$returnParam.price}" size="10">&nbsp;円
                </td>
            ...
            <tr>
                <th>付与ポイント</th>
                <td style="text-align: left;">
                    <input type="text" name="point" value="{$returnParam.point}" size="10">&nbsp;Pt
                </td>
                <td style="text-align: center;">任意</td>
            </tr>
            <tr>
            ...
            *}
            <tr>
                <th>表示優先度</th>
                <td style="text-align: left;">
                    <input type="text" name="sort_seq" value="{$returnParam.sort_seq|default:0}" size="10">
                </td>
                <td style="text-align: center;">任意</td>
            </tr>
            <tr>
                <td colspan="3"  style="text-align:center;">
                    <div class="SubMenu">
                        <input type="submit" name="action_itemManagement_itemMonthlyExec" value="登録する" onClick="return confirm('登録しますか？')"/>
                    </div>
                </td>
            </tr>
        </table>
