        ...
        <table border="0" cellspacing="0" cellpadding="0" class="TableSet01">
            <tr>
                ...
                <td style="text-align: left;">
                    <input type="text" name="name" value="{$returnParam.name}" size="100">
                </td>
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    <input type="text" name="html_text_name_pc" value="{$returnParam.html_text_name_pc}" size="100">
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    <input type="text" name="html_text_name_mb" value="{$returnParam.html_text_name_mb}" size="100">
                    &nbsp;<font color="blue">※HTMLタグを入力出来ます。</font>
                </td>
                <td style="text-align:center;color:#ff0000;">必須</td>
            </tr>
            <tr>
                ...
                <td style="text-align: left;">
                    <input type="text" name="remail_name" value="{$returnParam.remail_name}" size="100">
                </td>
                <td style="text-align:center;color:#ff0000;">必須</td>
            </tr>
            <tr>
                <th>カテゴリー</th>
                <td style="text-align: left;">{html_options name="item_category_id" options=$itemCategoryListForSelect selected=$registParam.item_category_id}</td>
            ...
            <tr>
                <th>販売開始日時</th>
                <td style="text-align: left;">
                    <input name="sales_start_date" class="datepicker" type="text" value="{$returnParam.sales_start_datetime|zend_date_format:'yyyy-MM-dd'}" size="15" maxlength="10">
                    <input name="sales_start_time" class="time" type="text" value="{$returnParam.sales_start_datetime|zend_date_format:'HH:mm:ss'}" size="10" maxlength="8">
            ...
            <tr>
                <th>販売終了日時</th>
                <td style="text-align: left;">
                    <input name="sales_end_date" class="datepicker" type="text" value="{$returnParam.sales_end_datetime|zend_date_format:'yyyy-MM-dd'}" size="15" maxlength="10">
                    <input name="sales_end_time" class="time" type="text" value="{$returnParam.sales_end_datetime|zend_date_format:'HH:mm:ss'}" size="10" maxlength="8">
                    &nbsp;<font color="blue">※日付は「0000-00-00 00:00:00」の形で入力してください。</font>
                </td>
            ...
            <tr>
                <th>入金状態</th>
                <td style="text-align: left;">{html_options name="payment_status" options=$paymentStatus selected=$registParam.payment_status|default:0}</td>
                <td style="text-align: center;">-----</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align:left;">
                    <input type="text" size="80" name="target_delete_item_id" value="{$returnParam.target_delete_item_id}" style="ime-mode:disabled">
                    </br>
            ...
            <tr>
                <th>販売価格</th>
                <td style="text-align: left;">
                    <input type="text" name="price" value="{$returnParam.price}" size="10" style="ime-mode:disabled">&nbsp;円
                </td>
            ...
            <tr>
                <th>付与月額コース</th>
                <td style="text-align: left;">
                    {html_options name="monthly_course_id" options=$monthlyCourseList selected=$registParam.monthlyCourseList|default:0 id="monthly_course_id"}
            ...
            <tr>
                <th>管理用コメント</th>
                <td style="text-align: left;">
                    <textarea name="comment" cols="80" rows="2" id="comment">{$returnParam.comment}</textarea>
                </td>
                <td style="text-align: center;">任意</td>
            </tr>
            ...
            <tr>
                <th>強制注文フラグ</th>
                <td style="text-align: left;">
                    {html_options name="is_self_order" options=$isSelfOrder selected=$returnParam.is_self_order|default:0}
