...
if (!$orderingData = $OrderingOBJ->getOrderingDataFromAccessKey($param["odid"], $comUserData["user_id"])) {
    ...
    $insertOrderingArray["status"] = Ordering::ORDERING_STATUS_WAIT_BITCASH;
    $insertOrderingArray["pay_type"] = Ordering::PAY_TYPE_BITCASH;
...
// 注文情報があれば更新
    ...
    // 注文情報更新
    $updateOrderingArray["status"] = Ordering::ORDERING_STATUS_WAIT_BITCASH;
    $updateOrderingArray["pay_type"] = Ordering::PAY_TYPE_BITCASH;
