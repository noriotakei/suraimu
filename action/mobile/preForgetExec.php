...
if ($validationOBJ->isError()) {
    ...
    header("Location: ./?action_PreForget=1" . ($comURLparam ? "&" . $comURLparam : "") . "&" . $sessId);
    exit;
}
...
header("Location: ./?action_PreForgetComplete=1" . ($comURLparam ? "&" . $comURLparam : "") . "&" . $sessId);
exit;
?>
