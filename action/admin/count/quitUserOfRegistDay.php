...
if (!$param["start_date"] AND !$param["end_date"] AND ComValidation::isDate($param["date"])) {
    $defaultWhereArray[] = "u.regist_datetime >= '" . $param["date"] . " 00:00:00'";
    $defaultWhereArray[] = "u.regist_datetime <= '" . $param["date"] . " 23:59:59'";
}
...
$smartyOBJ->assign("ageGroupList", $ageGroupList);
