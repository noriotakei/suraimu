...
$dataList = $AdmRegistTestAddressOBJ->getRegistTestAddressList($param, $offset, "id DESC", $dispCnt);
...
$pagerArray["action_name"] = "user_RegistTestAddressDelForm=1";
