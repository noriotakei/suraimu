...
$userList = $AdminUserOBJ->getBankDetailList($value);
...
$fileName = "bankDetailList_" . date("YmdHis") . ".csv";

header("Content-Type: application/octet-stream");
header("Content-Disposition: attachment; filename=" . $fileName);

foreach ($userList as $val) {
    print(mb_convert_encoding($val["bank_name"] . ",","SJIS","UTF-8"));
    print(mb_convert_encoding($val["branch_name"] . ",","SJIS","UTF-8"));
    print(mb_convert_encoding($val["type"] . ",","SJIS","UTF-8"));
    print(mb_convert_encoding($val["account_number"] . ",","SJIS","UTF-8"));
