...
$pagerArray["action_name"] = "banner_List=1";
...
$smartyOBJ->assign("searchTypeAry", AdmBanner::$searchTypeAry);

$smartyOBJ->assign("specifyKeywordAry", AdmBanner::$specifyKeywordAry);
