...
foreach ((array)$preRegistMonth as $key => $val) {
    $jsPaymentDataList["line1"][] = ($dispDataList[$val]["sales_user_0"] ? $dispDataList[$val]["sales_user_0"] : 0);
    $jsPaymentDataList["line2"][] = ($dispDataList[$val]["sales_user_31"] ? $dispDataList[$val]["sales_user_31"] : 0);
    $jsPaymentDataList["line3"][] = ($dispDataList[$val]["sales_user_61"] ? $dispDataList[$val]["sales_user_61"] : 0);
    $jsPaymentDataList["line4"][] = ($dispDataList[$val]["sales_user_91"] ? $dispDataList[$val]["sales_user_91"] : 0);
}
