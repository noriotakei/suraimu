...
foreach ((array)$preRegistMonth as $key => $val) {
    $data = "";
    $data["pay_total"] = $dispDataList[$val]["pay_total_0"] + $dispDataList[$val]["pay_total_31"] + $dispDataList[$val]["pay_total_61"] + $dispDataList[$val]["pay_total_91"];

    $jsPaymentDataList["line1"][] = $dispDataList[$val]["pay_total_0"] ? $dispDataList[$val]["pay_total_0"] / $data["pay_total"] * 100 : 0;
    $jsPaymentDataList["line2"][] = $dispDataList[$val]["pay_total_31"] ? $dispDataList[$val]["pay_total_31"] / $data["pay_total"] * 100 : 0;
    $jsPaymentDataList["line3"][] = $dispDataList[$val]["pay_total_61"] ? $dispDataList[$val]["pay_total_61"] / $data["pay_total"] * 100 : 0;
    $jsPaymentDataList["line4"][] = $dispDataList[$val]["pay_total_91"] ? $dispDataList[$val]["pay_total_91"] / $data["pay_total"] * 100 : 0;
}
