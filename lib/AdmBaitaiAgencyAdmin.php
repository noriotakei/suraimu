...
class AdmBaitaiAgencyAdmin extends ComCommon {
    ...
    public function insertData($insertArray) {
        ...
        if (!$dbResultOBJ = $this->insert("baitai_agency_admin", $insertArray)) {
    ...
    public function updateData($updateArray, $whereArray = null) {
        ...
        if (!$dbResultOBJ = $this->update("baitai_agency_admin", $updateArray, $whereArray)) {
    ...
    public function getData($id) {
        ...
        $sql = $this->makeSelectQuery("baitai_agency_admin", $columnArray, $whereArray);
