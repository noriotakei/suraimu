 ...
 */
class AdmBaitai extends ComCommon {
    ...
    public function getMediaCalculation($columnArray, $whereArray, $otherArray = "") {
        ...
        $sql = $this->makeSelectQuery("media_analyze", $columnArray, $whereArray, $otherArray);
    ...
    public function getUserData($id) {
        ...
        $sql = $this->makeSelectQuery("baitai_admin", $columnArray, $whereArray);
    ...
    public function insertData($insertArray) {
        ...
        if (!$dbResultOBJ = $this->insert("baitai_admin", $insertArray)) {
    ...
    public function updateData($updateArray, $whereArray = null) {
        ...
        if (!$dbResultOBJ = $this->update("baitai_admin", $updateArray, $whereArray)) {
