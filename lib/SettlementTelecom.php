 ...
 */
class SettlementTelecom extends Settlement {

    const CREDIT_CLIENT_IP = "57442";
    const CREDIT_SSL_URL   = "https://secure.telecomcredit.co.jp/inetcredit/secure/order.pl";
    const CREDIT_QUICK_URL = "http://secure.telecomcredit.co.jp/inetcredit/secure/cont.pl";
    ...
    public function setDefaultPostData() {
        ...
        switch ($this->_settleType) {
            case "ssl":
                $this->_defaultPostData["clientip"]  = self::CREDIT_CLIENT_IP;
                break;
            case "quick":
                $this->_defaultPostData["clientip"]  = self::CREDIT_CLIENT_IP;
                break;
    ...
    public function getCreditSettleUrl() {
        ...
        switch ($settleType) {
            // SSL
            case "ssl":
                $creditSettleUrl = self::CREDIT_SSL_URL;
                break;
            // クイックチャージ
            case "quick":
